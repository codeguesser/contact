...
#import "CGViewTableController.h"
#import "MBProgressHUD.h"
@interface CGViewTableController ()

@end

@implementation CGViewTableController
...
-(void)loadData{
    ...
    [HUD showAnimated:YES whileExecutingBlock:^{
        ...
        [HUD2 showAnimated:YES whileExecutingBlock:^{
            ...
            if(isReloadData)[self.tableView setContentOffset:CGPointMake(0, 0) animated:YES];
            isLoadFooter = NO;
